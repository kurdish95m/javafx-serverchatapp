...
public class ServerController implements Initializable {
    ...
    public void setServerInfo(UserInfo obj) {
        ...
        try {
            // TODO
            s = new Server(new ServerSocket(Integer.parseInt(userInfo.getPortNumber())));
            // s = new Server(new ServerSocket(Integer.parseInt("1234")));
        ...
        s.receiveMessageFromClient(vbox_message);
    }
    /**
    ...
    public void sendMessage() {
        ...
        if (!messeageToSend.isEmpty()) {
            ...
            s.sendMessageToClient(messeageToSend);
            tf_messsage.clear();
        }
    }
